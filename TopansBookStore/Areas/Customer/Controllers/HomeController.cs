...
namespace TopansBookStore.Controllers
{
    [Area("Customer")]
    public class HomeController : Controller
    {
        ...
        {
            return View(new TopansBookStore.Models.ViewModels.ErrorViewModel { RequestId = Activity.Current?.Id ?? HttpContext.TraceIdentifier });
        }
    }
}
